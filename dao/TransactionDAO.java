...
public class TransactionDAO {
    ...
    public List<Transaction> getAllTransactions(Long accNumber) throws SQLException{
        List<Transaction> allTransactions = new ArrayList<>();
        String query = "SELECT * FROM transactions WHERE AccountNumber = ? ORDER BY TransactionDate DESC";
        try(Connection con = DBUtil.getConnection();
